...
- (void)setup {
	...
	[self setBackgroundColor:[UIColor colorWithRed:240.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0]];
...
//    if (str.length > 0) {
//        NSString *subStr = [str substringWithRange:NSMakeRange(str.length-1, 1)];
//            NSLog(@"str == %@",subStr);
//    }
//    
    ...
    //NSLog(@"1 == %lu",(unsigned long)[string rangeOfCharacterFromSet:_tokenField.tokenizingCharacters].location);
    //NSLog(@"2 == %hhd",_tokenField.forcePickSearchResult);
