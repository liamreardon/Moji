...
@interface StickerCategoriesView ()

@end

@implementation StickerCategoriesView
...
-(NSInteger) tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    return [__appDelegate.__stickersArr count];
}
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    __appDelegate.__stickersCategories = [__appDelegate.__stickersArr objectAtIndex:indexPath.row];
    
    //NSLog(@"Title == %@",__appDelegate.__stickersCategories.__title);
    
    cell.textLabel.text = [[NSString stringWithFormat:@"%@", __appDelegate.__stickersCategories.__title] capitalizedString];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    StickerSubCatView *__stickerSubCatView = [[StickerSubCatView alloc] initWithNibName:@"StickerSubCatView" bundle:Nil];
    __stickerSubCatView.__catIndex = indexPath.row;
    
    [self.navigationController pushViewController:__stickerSubCatView animated:YES];
}
